            ...
            <div className='block text-center lg:text-start lg:flex lg:mt-20'>
                ...
                <div className='lg:w-1/3 '>
                    ...
                    <div className='flex flex-wrap gap-10 mt-10  z-50 '>
                        {/* whasup */}
                        <Link  href={'/'} className=' flex items-center  px-3  bg-opacity-5 bg-white  border-dashed border-slate-400 border-[1px] rounded-full'>
                        ...
                        {/* youtub */}
                        <Link href={'/'}  className=' flex items-center  px-3 py-3 bg-opacity-5 bg-white  border-dashed border-slate-400 border-[1px] rounded-full'>
                        ...
                        {/* instagram */}
                        <Link href={'/'} className=' flex items-center  px-3 py-2 bg-opacity-5 bg-white  border-dashed border-slate-400 border-[1px] rounded-full'>
                        ...
                        {/*  linked in */}
                        <Link href={'/'} className=' flex items-center  px-4 py-3 lg:py-2 bg-opacity-5 bg-white  border-dashed border-slate-400 border-[1px] rounded-full'>
                        ...
                        {/* facebook */}
                        <Link href={'/'} className=' flex items-center  px-5 py-4 lg:py-1 bg-opacity-5 bg-white  border-dashed border-slate-400 border-[1px] rounded-full'>
